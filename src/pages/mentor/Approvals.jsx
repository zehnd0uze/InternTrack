        ...
        {isExpanded && (
          <div className="border-t border-gray-100 bg-gray-50 p-4 space-y-3">
            ...
            {!showActions && approval.note && (
              <div className="pt-2">
                <p className="text-xs font-medium text-gray-500">หมายเหตุ:</p>
                <p className="text-sm text-gray-700 mt-1 italic">"{approval.note}"</p>
              </div>
            )}
          </div>
        )}
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">ตรวจสอบและอนุมัติคำขอชั่วโมงทำงานของนักศึกษาฝึกงาน</p>
      </div>
