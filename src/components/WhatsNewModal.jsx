  ...
  student: [
    {
      ...
      color: '#F59E0B',
      tag: 'ประกาศชี้แจง',
      title: 'สาเหตุของปัญหาข้อมูลสูญหาย',
      desc: 'เมื่อคืนวันที่ 2 ก.ค. 2569 ทีมงานได้อัปเกรดโครงสร้างฐานข้อมูลสถาบันการศึกษาครั้งใหญ่ ซึ่งกระบวนการล้างข้อมูลเก่าได้ส่งผลกระทบลูกโซ่ (Cascading delete) ทำให้ประวัติการลงเวลาและบันทึกของคุณถูกลบไปด้วยโดยไม่ได้ตั้งใจ ขออภัยอย่างสูงครับ',
      actions: [],
    },
    {
      icon: Clock,
      color: '#0EA5E9',
      tag: 'ฟีเจอร์ใหม่',
      title: 'คำนวณชั่วโมงเป้าหมายอัตโนมัติ',
      desc: 'ระบบจะคำนวณ "ชั่วโมงเป้าหมายที่ต้องทำ" และ "จำนวนวันฝึกงานทั้งหมด" ให้อัตโนมัติ โดยอ้างอิงจากวันที่เริ่มและสิ้นสุดการฝึกงานของคุณ (นับเฉพาะวันจันทร์-ศุกร์)',
      actions: [],
    },
    {
      icon: CheckCircle2,
      color: '#10B981',
      tag: 'ฟีเจอร์ใหม่',
      title: 'สร้างประวัติการลงเวลาย้อนหลัง',
      desc: 'ไม่ต้องมานั่งกดเช็คอินย้อนหลังทีละวันอีกต่อไป! ทันทีที่คุณกรอกวันที่เริ่มฝึกงานและเวลาเข้า-ออกงาน ระบบจะสร้างประวัติการลงเวลา (จันทร์-ศุกร์) ย้อนหลังให้จนถึงปัจจุบันแบบอัตโนมัติ',
      actions: [],
    },
    {
      icon: User,
      ...
      title: 'หน้าต่างตั้งค่าเริ่มต้น',
      desc: 'สำหรับผู้ที่ยังไม่ได้ใส่วันที่เริ่มฝึกงาน ระบบจะมีหน้าต่างเด้งขึ้นมาให้กรอกข้อมูลโดยอัตโนมัติเมื่อเข้าสู่หน้า Dashboard เพียงกรอกให้ครบแล้วกดบันทึกก็พร้อมใช้งานทันทีครับ',
      actions: [],
    },
    {
      icon: Shield,
      ...
      desc: 'เพื่อป้องกันเหตุข้อมูลสูญหายในอนาคต เราได้ติดตั้งระบบสำรองข้อมูล (Backup) ฐานข้อมูลอัตโนมัติทุกวัน ข้อมูลการลงเวลาและบันทึกของคุณจะถูกเก็บรักษาอย่างดีครับ',
      actions: [],
    },
    {
      icon: Bell,
      color: '#EC4899',
      tag: 'การแจ้งเตือน',
      title: 'เปิดรับแจ้งเตือน (Push Notifications)',
      desc: 'รับการแจ้งเตือนไม่ให้ลืมเช็คอิน/เช็คเอาท์',
      actions: [
        'คลิกที่ "ไอคอนกระดิ่ง" มุมซ้ายล่างของหน้าจอ',
        'กดปุ่ม "เปิดรับการแจ้งเตือน (Push)"',
        'กดยอมรับ (Allow) ในเบราว์เซอร์',
      ],
    },
  ],
  mentor: [
    {
      ...
      tag: 'ประกาศชี้แจง',
      title: 'สาเหตุของปัญหาข้อมูลสูญหาย',
      desc: 'เมื่อคืนวันที่ 2 ก.ค. 2569 ทีมงานได้อัปเกรดโครงสร้างฐานข้อมูลสถาบันการศึกษา ซึ่งกระบวนการล้างข้อมูลเก่าได้ส่งผลกระทบลูกโซ่ทำให้ประวัติการลงเวลาและข้อมูลบางส่วนของนักศึกษาถูกลบไปด้วย ขออภัยอย่างสูงครับ',
      actions: [],
    },
    {
      icon: Bell,
  ...
  supervisor: [
    {
      ...
      tag: 'ประกาศชี้แจง',
      title: 'สาเหตุของปัญหาข้อมูลสูญหาย',
      desc: 'เมื่อคืนวันที่ 2 ก.ค. 2569 การอัปเกรดฐานข้อมูลสถาบันการศึกษาได้ส่งผลกระทบลูกโซ่ทำให้ประวัติการลงเวลาของนักศึกษาถูกลบไปโดยไม่ได้ตั้งใจ ขอโทษแทนทีมงานด้วยครับ รบกวนแจ้งให้นักศึกษาทราบด้วยนะครับ',
